'use strict';
const CACHE='earforge-pwa2-307700a74e172612';
const ROOT=new URL('./',self.location.href).href;
const SCOPE_PATH=new URL('./',self.location.href).pathname;
const INDEX_PATH=new URL('index.html',ROOT).pathname;
const ASSETS=['','index.html','styles-9.0.0.css','app-9.0.0-catalog.js','app-9.0.0-learning.js','app-9.0.0-questions.js','app-9.0.0-audio-kernel.js','app-9.0.0-audio.js','app-9.0.0.js','app-10.0.0-labs.js','earforge-10.0.1.webmanifest','icon-192.png','icon-512.png','maskable-512.png','apple-touch-icon.png'].map(x=>new URL(x||'./',ROOT).href);
